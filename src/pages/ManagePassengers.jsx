...
//                 {/* Display ticket history if available */}
//                 {ticketHistory[passenger.id] &&
//                   ticketHistory[passenger.id].length > 0 && (
//                     <div className="mt-4">
//                       <h4 className="font-semibold">Ticket History:</h4>
//                       {ticketHistory[passenger.id].map((ticket) => (
//                         <div
//                           key={ticket.id}
//                           className="p-2 bg-white mt-2 rounded-md shadow-sm"
//                         >
        ...
        <div className="max-w-6xl my-4 mx-auto p-4 bg-white rounded-lg shadow-md">
          ...
          <Dialog.Root open={openDialog} onOpenChange={setOpenDialog}>
            ...
            <Dialog.Portal>
              ...
              <Dialog.Content className="fixed top-1/4 left-1/2 transform -translate-x-1/2 bg-white p-6 rounded-lg shadow-lg w-96 z-50">
